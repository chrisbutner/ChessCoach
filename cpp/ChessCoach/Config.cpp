...
int Config::CheckpointInterval = 100; // 1000; // Currently training about 10x as slowly as AlphaZero, so reduce accordingly.
int Config::WindowSize = 1000000;
int Config::SelfPlayGames = 1400000; // 44000000; // Smaller number for faster testing
